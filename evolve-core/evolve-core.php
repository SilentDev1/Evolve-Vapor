...
define( 'EVOLVE_CORE_VERSION', '1.12.0' );
...
require_once EVOLVE_CORE_DIR . 'includes/class-webp.php';
require_once EVOLVE_CORE_DIR . 'includes/class-category-seo.php';
...
add_action( 'plugins_loaded', function () {
	...
	new \Evolve_Core\Webp();
	new \Evolve_Core\Category_Seo();
